...
static const key_subst_t value_substitutions[] = {
    ...
    {"cdp/MsgDeposit", "Deposit Collateral"},
    {"cdp/MsgWithdraw", "Withdraw Collateral"},
    {"cdp/MsgDrawDebt", "Draw Debt"},
    {"cdp/MsgRepayDebt", "Repay Debt"},
    {"kava/MsgSubmitProposal", "Committee Propose"},
    {"kava/MsgVote", "Committee Vote"},
    {"incentive/MsgClaimReward", "Claim Reward"},
    {"pricefeed/MsgPostPrice", "Post Price"}};
